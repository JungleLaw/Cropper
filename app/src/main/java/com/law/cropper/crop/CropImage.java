...
import com.law.cropper.CropActivity;
...
public final class CropImage {
    ...
    /**
     * The key used to pass crop image source URI to {@link CropActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

    /**
     * The key used to pass crop image options to {@link CropActivity}.
     */
    ...
    /**
     * The request code used to start {@link CropActivity} to be used on result to identify the this specific
     * request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

    /**
     * The result code used to return error from {@link CropActivity}.
     */
     ...
     * {@link CropActivity} to crop the selected image.<br>
    ...
    /**
     * Create {@link ActivityBuilder} instance to start {@link CropActivity} to crop the given image.<br>
     * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} and can be retrieved
     * using {@link #getActivityResult(Intent)}.
     *
    ...
    /**
     * Get {@link CropActivity} result data object for crop image activity started using {@link #activity(Uri)}.
     *
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * the title of the {@link CropActivity}.<br>
         * <i>Default: ""</i>
         */
