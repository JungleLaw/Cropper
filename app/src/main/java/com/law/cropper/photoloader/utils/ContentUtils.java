package com.law.cropper.photoloader.utils;
...
public class ContentUtils {
    ...
    public static Uri getSharedPreferenceUri(final int preferenceId) {
        String uriString = getSharedPreferences().getString(App.getInstance().getString(preferenceId), null);
    ...
    public static void setSharedPreferenceUri(final int preferenceId, @Nullable final Uri uri) {
        ...
        if (uri == null) {
            editor.putString(App.getInstance().getString(preferenceId), null);
        } else {
            editor.putString(App.getInstance().getString(preferenceId), uri.toString());
        }
        editor.apply();
    }
